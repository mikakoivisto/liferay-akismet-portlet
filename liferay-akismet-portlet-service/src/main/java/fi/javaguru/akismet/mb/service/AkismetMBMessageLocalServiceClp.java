...
public class AkismetMBMessageLocalServiceClp
    ...
    public AkismetMBMessageLocalServiceClp(
        ...
        _methodName19 = "addAkismetMBMessage";
        ...
        _methodName20 = "updateAkismetMBMessage";
        ...
        _methodName23 = "getByGroupId";

        _methodParameterTypes23 = new String[] { "long", "int", "int" };

        _methodName24 = "getByGroupId";
    ...
    public fi.javaguru.akismet.mb.model.AkismetMBMessage addAkismetMBMessage(
        ...
        return (fi.javaguru.akismet.mb.model.AkismetMBMessage) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.javaguru.akismet.mb.model.AkismetMBMessage createAkismetMBMessage(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { akismetMBMessageId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.javaguru.akismet.mb.model.AkismetMBMessage deleteAkismetMBMessage(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { akismetMBMessageId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.javaguru.akismet.mb.model.AkismetMBMessage fetchAkismetMBMessage(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName9,
                    _methodParameterTypes9, new Object[] { akismetMBMessageId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.javaguru.akismet.mb.model.AkismetMBMessage getAkismetMBMessage(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { akismetMBMessageId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<fi.javaguru.akismet.mb.model.AkismetMBMessage> getAkismetMBMessages(
        ...
        return (java.util.List<fi.javaguru.akismet.mb.model.AkismetMBMessage>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.javaguru.akismet.mb.model.AkismetMBMessage updateAkismetMBMessage(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName15,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(akismetMBMessage),
    ...
    public fi.javaguru.akismet.mb.model.AkismetMBMessage addAkismetMBMessage(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    ...
                    ClpSerializer.translateInput(authorEmail),
                        
                    ClpSerializer.translateInput(authorUrl),
    ...
    public fi.javaguru.akismet.mb.model.AkismetMBMessage getByMessageId(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName25,
                    _methodParameterTypes25, new Object[] { mbMessageId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
